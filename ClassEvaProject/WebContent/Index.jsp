...
<body>
	...
	<section class="container">
		<form method="get" action="./Index.jsp" class="form-inline mt-3">
			...
			<a class="btn btn-primary mx-1 mt-2" data-toggle="modal" href="#registeredModal">등록하기</a>
		</form>
	</section>
  <div class="card bg-light mt-3">
        ...
        <div class="card-header bg-light">
          ...
          <div class="row">
            ...
            <div class="col-8 text-left">컴퓨터공학개론&nbsp;<small>김철수</small></div>
        ...
        <div class="card-body">
          ...
          <h5 class="card-title">
            ...
            정말 좋은 강의에요.&nbsp;<small>(2017년 1학기)</small>

          </h5>

          <p class="card-text">좋아하는 교수님 강의고 대학교 처음와서 배우는 강의라 재미있었어요.</p>
      ...
      <div class="card bg-light mt-3">
        ...
        <div class="card-header bg-light">
          ...
          <div class="row">
            ...
            <div class="col-8 text-left">자료구조&nbsp;<small>김영희</small></div>
        ...
        <div class="card-body">
          ...
          <h5 class="card-title">
            ...
            나쁘지 않은 것 같습니다.&nbsp;<small>(2017년 2학기)</small>

          </h5>

          <p class="card-text">자료구조는 처음 배웠는데 흥미로웠어요.</p>
      ...
      <div class="card bg-light mt-3">
        ...
        <div class="card-header bg-light">
          ...
          <div class="row">
            ...
            <div class="col-8 text-left">알고리즘&nbsp;<small>한경수</small></div>
